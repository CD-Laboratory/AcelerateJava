...
public class BR {
	...
	public static boolean isValidCPF(final String ssn) {
		...
		final Integer digit1 = caculate(ssn.substring(0, 9), weightSsn);
		
		final Integer digit2 = caculate(ssn.substring(0, 9) + digit1, weightSsn);
	...
	public static boolean isValidCNPJ(final String tin) {
		...
		final Integer digit1 = caculate(tin.substring(0, 12), weightTin);
		
		final Integer digit2 = caculate(tin.substring(0, 12) + digit1, weightTin);
